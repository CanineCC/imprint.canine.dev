...
public sealed class SiteNavigationTests
{
    ...
    private static NavigationItem[] ItemCount(int count) =>
        [.. Enumerable.Range(0, count).Select(_ => NavigationItem.Page(PageId.New(), null))];
    ...
    public void SetNavigation_valid_items_raises_navigation_changed()
    {
        var items = new[]
        {
            ...
            NavigationItem.Page(PageId.New(), LocalizedText.Of(En, "About us")),
        };
    ...
    public void SetNavigation_with_duplicate_pages_is_rejected()
    {
        ...
        var items = new[]
        {
            NavigationItem.Page(pageId, null),
            NavigationItem.Page(pageId, LocalizedText.Of(En, "Same page, other label")),
        };
    ...
    public void SetNavigation_with_unchanged_items_raises_nothing()
    {
        ...
        AggregateSpec.For<Site>()
            .Given(Created, new SiteNavigationChanged([NavigationItem.Page(pageId, LocalizedText.Of(En, "Home"))]))
            .When(s => s.SetNavigation([NavigationItem.Page(pageId, LocalizedText.Of(En, "Home"))]))
            .ThenNothing();
    }
    ...
    {
        var first = NavigationItem.Page(PageId.New(), null);
        var second = NavigationItem.Page(PageId.New(), null);
    ...
    public void SetNavigation_clearing_existing_navigation_raises_navigation_changed() =>
        AggregateSpec.For<Site>()
            .Given(Created, new SiteNavigationChanged([NavigationItem.Page(PageId.New(), null)]))
    ...
    public void SetNavigation_updates_the_navigation_state()
    {
        var items = new[]
        {
            NavigationItem.Page(PageId.New(), LocalizedText.Of(En, "Home")),
            NavigationItem.Page(PageId.New(), null),
        };
