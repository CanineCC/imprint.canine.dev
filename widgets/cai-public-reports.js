...
`;function b(e){let t=e.getAttribute("kicker"),r=e.getAttribute("heading"),a=e.getAttribute("lede");if(!t&&!r&&!a)return"";let n='<div class="mk-section-head">';return t&&(n+=`<span class="mk-kicker">${o(t)}</span>`),r&&(n+=`<h2>${p(r)}</h2>`),a&&(n+=`<p>${p(a)}</p>`),n+="</div>",n}var v=`
