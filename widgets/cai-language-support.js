...
`;function u(e){let a=e.getAttribute("kicker"),n=e.getAttribute("heading"),t=e.getAttribute("lede");if(!a&&!n&&!t)return"";let i='<div class="mk-section-head">';return a&&(i+=`<span class="mk-kicker">${s(a)}</span>`),n&&(i+=`<h2>${l(n)}</h2>`),t&&(i+=`<p>${l(t)}</p>`),i+="</div>",i}var m=`
