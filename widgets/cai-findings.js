...
`;function p(e){let n=e.getAttribute("kicker"),t=e.getAttribute("heading"),r=e.getAttribute("lede");if(!n&&!t&&!r)return"";let o='<div class="mk-section-head">';return n&&(o+=`<span class="mk-kicker">${s(n)}</span>`),t&&(o+=`<h2>${d(t)}</h2>`),r&&(o+=`<p>${d(r)}</p>`),o+="</div>",o}var h=`
