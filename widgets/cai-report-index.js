...
`;function y(n){let e=n.getAttribute("kicker"),t=n.getAttribute("heading"),a=n.getAttribute("lede");if(!e&&!t&&!a)return"";let r='<div class="mk-section-head">';return e&&(r+=`<span class="mk-kicker">${l(e)}</span>`),t&&(r+=`<h2>${m(t)}</h2>`),a&&(r+=`<p>${m(a)}</p>`),r+="</div>",r}var x=`
